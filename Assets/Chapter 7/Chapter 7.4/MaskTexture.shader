Shader "Chapter 7/MaskTexture"
{
   Properties{
        ...
        _SpecularMask("SpecularMaskTexture", 2D) = "white"{}
    ...
    SubShader{
        pass{
            ...
            fixed4 frag(v2f i): SV_TARGET{
                ...
                fixed3 specular =_SpecularScale * specularMask* _LightColor0.rgb * _Specular.rgb * pow(saturate(dot(half_vec, normal)),_Gloss);
